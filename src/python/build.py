...
def buildAttendance():
    ...
    with open("../../data/private/withheld.csv", "rb") as inp:
        cr = csv.reader(inp)
        cr.next()
        for row in cr:
    ...
    with open("../../data/public/csv/attendance-2014.csv", "wb") as out:
        cw = csv.writer(out)
        ...
        with open("../../data/private/attendance-2014.csv", "rb") as inp:
            cr = csv.reader(inp)
            for row in cr:
...
def buildVolunteers():
    ...
    with open("../../data/private/withheld.csv", "wb") as out_private:
        ...
        with open("../../data/public/csv/volunteers.csv", "w") as out_public:
